...
// the fields the board may change on a task (PATCH /api/tasks/[id])
export type TaskPatch = Partial<Pick<Task, 'title' | 'notes' | 'status' | 'priority' | 'due_date' | 'company_id' | 'checklist'>>;
