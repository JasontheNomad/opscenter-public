...
// ---- manual ordering (local). favorites order = teams_favs array order; chats have none (newest first)
const orderKey = (k: 'team' | 'channel') => `teams_${k}_order`;
...
// kind: favs | teams | channels:<teamId>
