<script lang="ts">
	...
	const GOTO: Record<string, string> = { p: '/projects', s: '/support', v: '/vault', m: '/teams', a: '/calendar' };
	...
	const HELP: [string, string][] = $derived([
		...
		['c', 'new task'], ['/', 'search'], ['g p/s/v/m/a', 'go Projects / Support / Vault / Teams / cAlendar'], ['?', 'this help']
	]);
</script>
